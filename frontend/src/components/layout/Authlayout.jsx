...
import graphimage from '../../assets/images/jakub-zerdzicki-zoubZIvKa7M-unsplash.jpg';
...
export default function Authlayout({ children }) {
      return (
            <div className='flex'>
                  ...
                  <div className='hidden md:block w-[50vw] h-screen bg-amber-100 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
                        ...
                        <img src={graphimage} className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15' />
                  </div>
            </div>
      );
}
